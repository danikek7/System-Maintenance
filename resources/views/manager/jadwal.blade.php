...
<head>
    <meta charset="UTF-8">
    <title>Daftar Jadwal Menunggu Persetujuan - Manager</title>
                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="p-6">
                        ...
                        <div class="overflow-x-auto">
                            <h2 class="text-xl font-bold text-gray-900">Daftar Jadwal Menunggu Persetujuan</h2><br />
                            @if ($jadwals->count() > 0)
                                    ...
                                    <tbody>
                                        @foreach ($jadwals as $index => $jadwal)
                                            <tr
                                                ...
                                                <td class="px-4 py-4 text-sm text-gray-900 border text-center">
                                                    <a href="{{ route('manager.jadwal.detail', $jadwal->id) }}"
                                                ...
                                                <form action="{{ route('manager.jadwal.approve', $jadwal->id) }}" method="POST" 
                                                    onsubmit="return confirm('Setujui jadwal ini?')">
                                                    @csrf
                                                    <button type="submit" 
