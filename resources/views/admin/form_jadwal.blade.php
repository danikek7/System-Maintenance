        ...
        <div class="flex-1 flex flex-col overflow-auto p-8">
            <div class="max-w-3xl mx-auto bg-white shadow rounded-lg p-8">
                ...
                <form action="{{ route('admin.jadwal.tambah') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label for="nama_jadwal" class="block font-medium mb-1">Nama Jadwal</label>
                        <input
                            type="text"
                            id="nama_jadwal"
                            name="nama_jadwal"
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('admin.jadwal') }}" class="inline-block px-6 py-2 border border-gray-300 rounded hover:bg-gray-100">
