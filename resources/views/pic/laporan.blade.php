        ...
        <div class="flex-1 flex flex-col">
            ...
            <div class="sidebar-gradient text-white p-4 flex justify-between items-center shadow">
                <div class="text-lg font-semibold">
                    {{-- Daftar Jadwal Menunggu Persetujuan --}}
                </div>
                <div class="flex items-center space-x-3">
                                ...
                                <table class="w-full border-collapse">
                                    <thead class="bg-blue-600 text-white">
                                        <tr>
                                            ...
                                            <th class="px-4 py-3 text-center text-sm font-semibold border">Nama Jadwal</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="{{ $index % 2 == 0 ? 'bg-white' : 'bg-gray-50' }} hover:bg-blue-50 transition">
                                            <td class="px-4 py-4 text-sm text-gray-900 border text-center">{{ $jadwals->firstItem() + $index }}</td>
                                            <td class="px-4 py-4 text-sm text-gray-900 border text-center">{{ $jadwal->nama }}</td>
                                            <td class="px-4 py-4 text-sm text-gray-900 border text-center">{{ $jadwal->bulan }}</td>
                                            <td class="px-4 py-4 text-sm text-gray-900 border text-center">
                                                <a href="{{ route('pic.laporan.show', $jadwal->id) }}" 
